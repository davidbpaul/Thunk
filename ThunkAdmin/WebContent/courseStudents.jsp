...
<body>
  <nav class="navbar navbar-inverse" style="margin-bottom:0px;">
    ...
    <%
			...
			String id = request.getParameter("us");
  ...
  <div class="focusPoint">
    <div class="col-md-10 col-md-offset-1">
      <div class="loginOuterNew">
        <div class="loginPadding">
          <div class="signInHeader">
            <h1 class="signInHeaderFont">Course Builder</h1>
          </div>
              ...
              <div class="loginForm col-md-10 col-md-offset-1">
                <form action="New" method="post">
                  <div class="col-md-4 col-md-offset-8">
                    <button name="update" type="submit" class="btn btn-block btn-success">Create Course</button>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Effort</label>
                    <input name="effort"type="text" class="form-control" id="exampleInputEmail1" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Length</label>
                    <input name="length"type="text" class="form-control" id="exampleInputEmail1" >
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Learn</label>
                    <input name="learn"type="text" class="form-control" id="exampleInputEmail1" >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Learn2</label>
                    <input name="learn2"type="text" class="form-control" id="exampleInputEmail1" >
                  </div>
                     <div class="form-group">
                    <label for="exampleInputEmail1">Learn3</label>
                    <input name="learn3"type="text" class="form-control" id="exampleInputEmail1" >
                  </div>
