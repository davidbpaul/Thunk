...
<html>
    ...
    <div class="focusPoint">
      <div class="col-md-6 col-md-offset-3">
        <div class="loginOuterRegistration">
          <div class="loginPadding">
            <div class="signInHeader">
              <h1 class="signInHeaderFont">Registration</h1>
                ...
                <div class="loginForm col-md-10 col-md-offset-1">
                  <form action="Registration" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input name="passwordRepeat"type="password" class="form-control" id="exampleInputPassword1" placeholder="Repeat Password">
                    </div>
                    <div class="col-md-4 col-md-offset-8">
                      <button name="REGISTER" type="submit" class="btn-lg btn-block btn-primary">Register</button>
                    </div>
                  </form>
                </div>
                <div class="row">
                  <div class="registerLoginForm col-md-10 col-md-offset-1">
                    <span ><p class="LoginToRegister">Have an account?</p><a href="login.jsp"> Login.</a></span>
                  </div>
                </div>
              </div>
            </div>
